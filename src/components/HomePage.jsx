      ...
      <div className="main-section d-flex flex-column flex-lg-row justify-content-between align-items-center p-5">
        <div style={{ maxWidth: "600px" }}>
          <h1 className="display-5 fw-bold text-success mb-4">
            L'application dédiée à améliorer le quotidien des patients
            diabétiques
          </h1>
          <p className="lead mb-4">
            La solution numérique de télésuivi médical pensée pour le Sénégal,
            qui facilite la connexion entre le patient diabétique et son équipe
            de soins, pour un accompagnement plus simple, régulier et
